...
int main(int argc, char** argv) {
	...
	Vertex triangles[] = {
		...
		//pohon
		Vertex(glm::vec3(-0.5f, -0.7f, 0), glm::vec3(0.0f, 0.941406f, 0.0f), 2),
		Vertex(glm::vec3(-0.9f, -0.7f, 0), glm::vec3(0.0f, 0.507812f, 0.0f), 2),
		Vertex(glm::vec3(-0.7f, -0.3f, 0), glm::vec3(0.0f, 0.992188f, 0.0f), 2),
		Vertex(glm::vec3(-0.5f, -0.5f, 0), glm::vec3(0.0f, 0.593750f, 0.0f), 2),
		Vertex(glm::vec3(-0.9f, -0.5f, 0), glm::vec3(0.0f, 0.882812f, 0.0f), 2),
		Vertex(glm::vec3(-0.7f, -0.1f, 0), glm::vec3(0.0f, 0.089844f, 0.0f), 2),
		Vertex(glm::vec3(-0.5f, -0.3f, 0), glm::vec3(0.0f, 0.328125f, 0.0f), 2),
	...
	Vertex quads[] = {
		...
		Vertex(glm::vec3(1.0, 1.0, -1.0),  glm::vec3(0.5, 0.7, 1.0), 0),
		Vertex(glm::vec3(1.0, -1.0, -1.0),  glm::vec3(0.8, 0.9, 1.0), 0),
		Vertex(glm::vec3(-0.65, -1, 0), glm::vec3(0.5, 0.25, 0.0), 2),
		Vertex(glm::vec3(-0.65, -0.7, 0),  glm::vec3(0.6, 0.3, 0.0), 2),
		Vertex(glm::vec3(-0.75, -0.7, 0),  glm::vec3(0.6, 0.3, 0.0), 2),
		Vertex(glm::vec3(-0.75, -1, 0),  glm::vec3(0.5, 0.25, 0.0), 2),
		Vertex(glm::vec3(0.65, -1, 0), glm::vec3(0.5, 0.25, 0.0), 2),
		Vertex(glm::vec3(0.65, -0.7, 0),  glm::vec3(0.6, 0.3, 0.0), 2),
		Vertex(glm::vec3(0.75, -0.7, 0),  glm::vec3(0.6, 0.3, 0.0), 2),
		Vertex(glm::vec3(0.75, -1, 0),  glm::vec3(0.5, 0.25, 0.0), 2),
	...
	Circle circle[] = {
		// pelangi
		Circle(glm::vec3(0, 0, 0), glm::vec3(1.0, 0.0, 0.0), glm::vec3(1.0, 127.0 / 255.0, 0.0), 0.7, 0),
		Circle(glm::vec3(0, 0, 0), glm::vec3(1.0, 127.0/255.0, 0.0), glm::vec3(1.0, 1.0, 0.0), 0.67, 0),
		Circle(glm::vec3(0, 0, 0), glm::vec3(1.0, 1.0, 0.0), glm::vec3(0.0, 1.0, 0.0), 0.64, 0),
		Circle(glm::vec3(0, 0, 0), glm::vec3(0.0, 1.0, 0.0), glm::vec3(0.0, 0.0, 1.0), 0.61, 0),
		Circle(glm::vec3(0, 0, 0), glm::vec3(0.0, 0.0, 1.0), glm::vec3(75.0 / 255.0, 0.0, 130.0 / 255.0), 0.58, 0),
		Circle(glm::vec3(0, 0, 0), glm::vec3(75.0/255.0, 0.0, 130.0 / 255.0), glm::vec3(139.0 / 255.0, 0.0, 1.0), 0.55, 0),
		Circle(glm::vec3(0, 0, 0), glm::vec3(139.0 / 255.0, 0.0, 1.0), glm::vec3(0.0, 0.0, 0.0), 0.52, 0),

		// reset color
		Circle(glm::vec3(0, 0, 0), glm::vec3(0.5, 0.7, 1.0), glm::vec3(0.5, 0.7, 1.0), 0.49, 0),

		// matahari
		Circle(glm::vec3(0.031, 0, 0), glm::vec3(1,245.0/255,0), glm::vec3(1,1,0), 0.1965, 0),
	};
